                ...
                <div class="col-span-12 lg:col-span-8">
                    <div class="flex flex-col md:flex-row md:justify-between mb-5 gap-4">
                        <div class="flex flex-col">
                            ...
                            <p class="text-gray-400 text-xs">
                                Kumpulan daftar persediaan barang
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                        @foreach ($products as $product)
                            <div class="relative bg-white p-4 rounded-lg bordered shadow-custom" style="border: solid 1px #c0c0c0">
                                ...
                                <div class="flex flex-col gap-2 py-2">
                                    ...
                                    @if ($product->quantity > 0)
                                        <form action="{{ route('cart.store', $product->slug) }}" method="POST">
                                            @csrf
                                            <button
                                                class="text-yellow-700 bg-green-700 p-2 rounded-lg text-sm text-center hover:bg-gray-300 w-full"
                                                type="submit">
